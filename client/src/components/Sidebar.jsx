            ...
            <div className='pb-5'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative py-2 '>
                        <img onClick={(e)=>{e.stopPropagation();  setMenuOpen((prev) => !prev)}} src={assets.menu_icon} alt='menu' className='max-h-5 cursor-pointer' />
                       {menuOpen && (
                    ...
                    return (
                        <div
                            ...
                            onClick={() => {
                                ...
                                // ✅ Reset unseen message count when opening chat
